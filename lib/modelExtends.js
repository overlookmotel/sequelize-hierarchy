...
module.exports = function(Sequelize) {
	...
	return {
		isHierarchy: function(options) {
			...
			this.rawAttributes[options.levelFieldName] = levelFieldDefinition;
			...
			if (options.foreignKeyAttributes) _.extend(this.rawAttributes[options.foreignKey], options.foreignKeyAttributes);

			// create labels
			if (options.labels) {
				[options.levelFieldName, options.foreignKey].forEach(function(fieldName) {
					var field = this.rawAttributes[fieldName];
			...
			var throughFields = {};
			throughFields[options.throughKey] = {type: this.rawAttributes[options.primaryKey].type, allowNull: false, primaryKey: true};
			throughFields[options.throughForeignKey] = {type: this.rawAttributes[options.primaryKey].type, allowNull: false, primaryKey: true};
