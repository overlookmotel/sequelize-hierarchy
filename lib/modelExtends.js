...
module.exports = {
	isHierarchy: function(options) {
		...
		_.defaults(options, {
			foreignKey: options.as + Utils.uppercaseFirst(options.primaryKeyAttribute),
			throughKey: this.name + Utils.uppercaseFirst(options.primaryKeyAttribute),
			throughForeignKey: Utils.singularize(options.ancestorsAs) + Utils.uppercaseFirst(options.primaryKeyAttribute),
		...
		var throughFields = {};
		throughFields[options.throughKey] = {type: this.attributes[options.primaryKeyAttribute].type, allowNull: false, primaryKey: true};
		throughFields[options.throughForeignKey] = {type: this.attributes[options.primaryKeyAttribute].type, allowNull: false, primaryKey: true};
	...
	rebuildHierarchy: function(options) {
		...
		var model = this,
			...
			primaryKey = hierarchy.primaryKeyAttribute,
