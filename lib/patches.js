...
module.exports = function(Sequelize) {
    ...
    return semverSelect.object(sequelizeVersion, {
        ...
        uppercaseFirst: {
            '>=5.0.0 || >=5.0.0-beta': function uppercaseFirst(s){
        ...
        query: {
            ...
            '>=3.0.0 || >=5.0.0-beta': function(sequelize, sql, options) {
        ...
        find: {
            ...
            '>=3.0.0 || >=5.0.0-beta': function(model, options) {
        ...
        instancePrototype: {
            ...
            '>=4.0.0 || >=5.0.0-beta': function(model) {
